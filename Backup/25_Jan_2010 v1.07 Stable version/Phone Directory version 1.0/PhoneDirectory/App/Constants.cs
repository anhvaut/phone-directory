...
namespace Wollundra.App
{
    public class Constants
    {
        ...
        private static AppConfig appConfig = new AppConfig(Constants.GetConfigFilePath());
        ...
        public static bool IsRunAsWindowsService()
        {
            return appConfig.GetValue("WindowsService").Equals("yes");
        }
